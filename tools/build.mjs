...
function caseSpine(cases, prefix, currentId = "") {
  const title = currentId ? "Choose another practice case" : "Six practice cases";
...
function featuredCasePanel(record) {
  return `<a class="featured-case-panel" href="cases/${record.id}/" aria-label="Try synthetic case 03: decide whether the citation supports the answer" data-home-preview="${record.id}" data-synthetic-case>
    ...
    <dl class="featured-evidence-list">
      ...
      <div class="featured-evidence-row featured-finding"><dt>Finding</dt><dd>${findingLabel(record.expected_finding)}</dd>${arrowIcon()}</div>
    </dl>
    <span class="featured-case-summary">The cited passage does not support the answer.</span>
  </a>`;
}
